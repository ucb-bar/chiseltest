...
#include <jni.h>
/* Header for class chiseltest_simulator_jni_JniAPI */

#ifndef _Included_chiseltest_simulator_jni_JniAPI
#define _Included_chiseltest_simulator_jni_JniAPI
#ifdef __cplusplus
extern "C" {
#endif
/*
 * Class:      chiseltest_simulator_jni_JniAPI
 * Method:     load_1so
 ...
 * Signature:  (IJI[Ljava/lang/String;)V
 */
